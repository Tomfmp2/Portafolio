    ...
    <section id="proyectos" className="section bg-[#0B0B0F]">
      <div className="page-container">
          ...
          {p.items.map((project, index) => {
            ...
            return (
              <div key={index} className="group glass card-hover p-7 flex flex-col h-full">
                ...
                <h3 className="text-lg font-bold text-white mb-2 tracking-tight group-hover:text-[#FF3333] transition-colors duration-300">
                  {project.title}
                </h3>
        ...
        <div className="text-center mt-14">
          <a href="https://github.com/Tomfmp2" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-7 py-3 border border-white/[0.1] text-white/60 hover:text-white hover:border-[#FF3333] rounded-full text-sm font-medium transition-all duration-300 hover:bg-[#FF3333]/10">
            {p.viewAll}
          </a>
        </div>
      </div>
